...
function updateStatus(studentId, status) {
    var studentFound = students.find(function (student) { return student.studentId == studentId; });
    if (!studentFound)
        return "Student not found";
    studentFound.status = status;
    return "".concat(studentFound.name, " has ").concat(studentFound === null || studentFound === void 0 ? void 0 : studentFound.status);
}
function addSubject(studentId, subject) {
    var studentFound = students.find(function (student) { return student.studentId == studentId; });
    if (!studentFound)
        return "Student not found";
    studentFound === null || studentFound === void 0 ? void 0 : studentFound.subjects.push(subject);
    return "".concat(subject, " added to ").concat(studentFound === null || studentFound === void 0 ? void 0 : studentFound.name, "'s subjects");
}
